---
title: Blog
description: Javascript, NodeJs, Php, Laravel, Css3, React, Html5, Técnologia.
pagination:
    collection: posts
    perPage: 4
---
...
@section('body')
@if (!$pagination)
    @include('_components.whoiam')
@else
    <header class="flex items-center justify-center">
        <div class="ml-10 text-center">
            <img src="/assets/images/perfil.jpg" alt="Foto do Autor" class="w-32 h-32 rounded-full mx-auto">
            <h1 class="text-3xl font-bold mb-2">Olá, eu sou Denis. 👋</h1>
            <p class="text-gray-600 m-0">Sou desenvolvedor de software e amante de cozinha</p>
            <p class="text-gray-600 mb-4 mt-0">PHP, Laravel, MySql, Git, Html5, CSS3, Javascript, JQuery, React, Bootstrap. </p>
